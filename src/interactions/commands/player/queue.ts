        ...
        await interaction.editReply({
            embeds: [
                new EmbedBuilder()
                    ...
                    .setDescription(
                        `**${this.embedOptions.icons.nyctophileZuiPlay} Now playing**\n` +
                            ...
                            `**${this.embedOptions.icons.queue} Lagu (tracks) dalam antrian**\n` +
    ...
    private async handleInvalidPage(
        ...
        await interaction.editReply({
            embeds: [
                new EmbedBuilder()
                    .setDescription(
                        `**${this.embedOptions.icons.nyctophileZuiMegaphone} | Oops!** Halaman **\`${
                            pageIndex + 1
                        }\`** bukan nomor halaman yang valid. Aku cuma mempunyai **\`${totalPages}\`** halaman dalam antrian.`
                    )
